...
function selectPattern(type, btn) {
  ...
  const showPatColor = type === "circle" || type === "stripe" || type === "layered";
  const showPatScale = type === "circle" || type === "stripe" || type === "layered";
  document.getElementById("pattern-color-section").classList.toggle("ctrl-hidden", !showPatColor);
  document.getElementById("pattern-scale-section").classList.toggle("ctrl-hidden", !showPatScale);
...
async function generatePattern() {
  ...
  try {
    ...
    document.getElementById("design-scale-section").classList.remove("ctrl-hidden");
    drawCanvas();
